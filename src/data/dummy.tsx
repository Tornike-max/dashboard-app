...
import { formatDate } from "../ui/formateDate";
import {
  ReactElement,
...
export const EditorData = () => (
  <div>
    <h3>
      Try React: any React: any has: any been: any designed: any from: any the:
      any start: any for gradual adoption, and you can use as little or as much
      React as you need. Whether you want to get a taste of React, add some
      interactivity to a simple HTML page, or start a complex React-powered app,
      the links in this section will help you get started. Online Playgrounds If
      you’re interested in playing around with React, you can use an online code
      playground. Try a Hello World template on CodePen, CodeSandbox, or
      Stackblitz. If you prefer to use your own text editor, you can also
      download this HTML file, edit it, and open it from the local filesystem in
      your browser. It does a slow runtime code transformation, so we’d only
      recommend using this for simple demos. Add React to a Website You can add
      React to an HTML page in one minute. You can then either gradually expand
      its presence, or keep it contained to a few dynamic widgets. Create a New
      React App When starting a React project, a simple HTML page with script
      tags might still be the best option. It only takes a minute to set up! As
      ...
      lets you take full advantage of the rich React ecosystem. Learn how. Learn
      React People come to React from different backgrounds and with different
      learning styles. Whether you prefer a more theoretical or a practical
      approach, we hope you’ll find this section helpful. If you prefer to learn
      by doing, start with our practical tutorial. If you prefer to learn
      concepts step by step, start with our guide to main concepts. Like any
      unfamiliar technology, React does have a learning curve. With practice and
      some patience, you will get the hang of it. First Examples The React
      homepage contains a few small React examples with a live editor. Even if
      you don’t know anything about React yet, try changing their code and see
      how it affects the result. React for Beginners If you feel that the React
      documentation goes at a faster pace than you’re comfortable with, check
      out this overview of React by Tania Rascia. It introduces the most
      important React concepts in a detailed, beginner-friendly way. Once you’re
      done, give the documentation another try! React for Designers If you’re
      coming from a design background, these resources are a great place to get
      started. JavaScript Resources The React documentation assumes some
      familiarity with programming in the JavaScript language. You don’t have to
      be an expert, but it’s harder to learn both React and JavaScript at the
      same time. We recommend going through this JavaScript overview to check
      your knowledge level. It will take you between 30 minutes and an hour but
...
const areaChartData = [
  [
    { x: formatDate(new Date(2002, 0, 1).toISOString()), y: 2.2 },
    { x: formatDate(new Date(2003, 0, 1).toISOString()), y: 3.4 },
    { x: formatDate(new Date(2004, 0, 1).toISOString()), y: 2.8 },
    { x: formatDate(new Date(2005, 0, 1).toISOString()), y: 1.6 },
    { x: formatDate(new Date(2006, 0, 1).toISOString()), y: 2.3 },
    { x: formatDate(new Date(2007, 0, 1).toISOString()), y: 2.5 },
    { x: formatDate(new Date(2008, 0, 1).toISOString()), y: 2.9 },
    { x: formatDate(new Date(2009, 0, 1).toISOString()), y: 3.8 },
    { x: formatDate(new Date(2010, 0, 1).toISOString()), y: 1.4 },
    { x: formatDate(new Date(2011, 0, 1).toISOString()), y: 3.1 },
  ],
  [
    { x: formatDate(new Date(2002, 0, 1).toISOString()), y: 2 },
    { x: formatDate(new Date(2003, 0, 1).toISOString()), y: 1.7 },
    { x: formatDate(new Date(2004, 0, 1).toISOString()), y: 1.8 },
    { x: formatDate(new Date(2005, 0, 1).toISOString()), y: 2.1 },
    { x: formatDate(new Date(2006, 0, 1).toISOString()), y: 2.3 },
    { x: formatDate(new Date(2007, 0, 1).toISOString()), y: 1.7 },
    { x: formatDate(new Date(2008, 0, 1).toISOString()), y: 1.5 },
    { x: formatDate(new Date(2009, 0, 1).toISOString()), y: 2.8 },
    { x: formatDate(new Date(2010, 0, 1).toISOString()), y: 1.5 },
    { x: formatDate(new Date(2011, 0, 1).toISOString()), y: 2.3 },
  ],
  [
    { x: formatDate(new Date(2002, 0, 1).toISOString()), y: 0.8 },
    { x: formatDate(new Date(2003, 0, 1).toISOString()), y: 1.3 },
    { x: formatDate(new Date(2004, 0, 1).toISOString()), y: 1.1 },
    { x: formatDate(new Date(2005, 0, 1).toISOString()), y: 1.6 },
    { x: formatDate(new Date(2006, 0, 1).toISOString()), y: 2 },
    { x: formatDate(new Date(2007, 0, 1).toISOString()), y: 1.7 },
    { x: formatDate(new Date(2008, 0, 1).toISOString()), y: 2.3 },
    { x: formatDate(new Date(2009, 0, 1).toISOString()), y: 2.7 },
    { x: formatDate(new Date(2010, 0, 1).toISOString()), y: 1.1 },
    { x: formatDate(new Date(2011, 0, 1).toISOString()), y: 2.3 },
  ],
];
...
export const lineChartData = [
  [
    { x: formatDate(new Date(2005, 0, 1).toISOString()), y: 21 },
    { x: formatDate(new Date(2006, 0, 1).toISOString()), y: 24 },
    { x: formatDate(new Date(2007, 0, 1).toISOString()), y: 36 },
    { x: formatDate(new Date(2008, 0, 1).toISOString()), y: 38 },
    { x: formatDate(new Date(2009, 0, 1).toISOString()), y: 54 },
    { x: formatDate(new Date(2010, 0, 1).toISOString()), y: 57 },
    { x: formatDate(new Date(2011, 0, 1).toISOString()), y: 70 },
  ],
  [
    { x: formatDate(new Date(2005, 0, 1).toISOString()), y: 28 },
    { x: formatDate(new Date(2006, 0, 1).toISOString()), y: 44 },
    { x: formatDate(new Date(2007, 0, 1).toISOString()), y: 48 },
    { x: formatDate(new Date(2008, 0, 1).toISOString()), y: 50 },
    { x: formatDate(new Date(2009, 0, 1).toISOString()), y: 66 },
    { x: formatDate(new Date(2010, 0, 1).toISOString()), y: 78 },
    { x: formatDate(new Date(2011, 0, 1).toISOString()), y: 84 },
  ],

  [
    { x: formatDate(new Date(2005, 0, 1).toISOString()), y: 10 },
    { x: formatDate(new Date(2006, 0, 1).toISOString()), y: 20 },
    { x: formatDate(new Date(2007, 0, 1).toISOString()), y: 30 },
    { x: formatDate(new Date(2008, 0, 1).toISOString()), y: 39 },
    { x: formatDate(new Date(2009, 0, 1).toISOString()), y: 50 },
    { x: formatDate(new Date(2010, 0, 1).toISOString()), y: 70 },
    { x: formatDate(new Date(2011, 0, 1).toISOString()), y: 100 },
  ],
];
...
export const pieChartData = [
  { label: "Labour", id: 18, value: 18 },
  { label: "Legal", id: 8, value: 8 },
  { label: "Production", id: 15, value: 15 },
  { label: "License", id: 11, value: 11 },
  { label: "Facilities", id: 19, value: 19 },
  { label: "Taxes", id: 14, value: 14 },
  { label: "Insurance", id: 16, value: 16 },
];
...
export const ecomPieChartData = [
  { x: "2018", value: 18, label: "35%" },
  { x: "2019", value: 18, label: "15%" },
  { x: "2020", value: 18, label: "25%" },
  { x: "2021", value: 18, label: "25%" },
];
